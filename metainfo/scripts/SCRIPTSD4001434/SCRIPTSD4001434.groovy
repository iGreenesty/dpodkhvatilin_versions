 ...
 * @TEMPLATE_TASK - код ссылки на шаблон на форме
 * @START_TIME - код параметра даты начала на форме
 * @SERVICE_TIME - код атрибута класса обслуживания
 * @TIME_ZONE - код атрибута часого пояса
 * @INTERVAL - код атрибута с временным интервалом
